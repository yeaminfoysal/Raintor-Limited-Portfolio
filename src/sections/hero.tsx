...
export default function Hero() {
    return (
        <div className="min-h-screen bg-cover bg-center" >
            ...
            <div className='text-center w-[703px] mx-auto mt-[50px]'>
                <p className='mb-[42px]'>Building the worlds best marketing websites for over a decade. Your trusted partner for strategy, design, and dev.</p>
